...
// Local import
const ButtonBuilderWrapper_1 = require("../../InteractionButtons/ButtonBuilderWrapper");
const FoxxoOrNotFoxxo_1 = require("../../../Enums/FoxxoOrNotFoxxo");
function default_1(interaction, mongo) {
    return __awaiter(this, void 0, void 0, function* () {
        if (interaction.commandName !== "foxxo-on-a-timer")
            return;
        ...
        let buttons = yield (0, ButtonBuilderWrapper_1.ButtonBuilderWrapper)([
            {
                customID: `ft|${JSON.stringify({
                    t: FoxxoOrNotFoxxo_1.FoxxoOrNotFoxxo.Foxxo,
                    gid: guildID,
                    cid: channelID,
                    i: 1
                })}`,
...
//# sourceMappingURL=FoxxoOnATimer.js.map