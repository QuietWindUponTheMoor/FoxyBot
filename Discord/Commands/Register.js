...
const ContentQueueSFW_1 = require("../Collectors/ContentQueues/ContentQueueSFW");
const ContentQueueNSFW_1 = require("../Collectors/ContentQueues/ContentQueueNSFW");
class Commands {
    ...
    InteractionsHandler() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.client.on(discord_js_1.Events.InteractionCreate, (interaction) => __awaiter(this, void 0, void 0, function* () {
                ...
                // Manual handlers
                yield (0, ContentQueueSFW_1.ContentQueueSFW)(interaction, this.mongo);
                yield (0, ContentQueueNSFW_1.ContentQueueNSFW)(interaction, this.mongo);
            }));
        });
    }
}
