...
import { ContentQueueSFW } from "../Collectors/ContentQueues/ContentQueueSFW";
import { ContentQueueNSFW } from "../Collectors/ContentQueues/ContentQueueNSFW";
...
export class Commands {
    ...
    async InteractionsHandler(): Promise<void> {
        ...
        this.client.on(Events.InteractionCreate, async interaction => {
            ...
            // Manual handlers
            await ContentQueueSFW(interaction as ChatInputCommandInteraction, this.mongo as WildMongo);
            await ContentQueueNSFW(interaction as ChatInputCommandInteraction, this.mongo as WildMongo);
        });
    }
}