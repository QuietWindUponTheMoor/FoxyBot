...
const NextQueueItem_1 = require("../Helpers/NextQueueItem");
function ContentQueueNSFW(interaction, mongo) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let message = yield (0, NextQueueItem_1.NextQueueItem)(interaction, mongo, "queue-nsfw", true); // Shut up, compiler
        ...
        collector.on("collect", (i) => __awaiter(this, void 0, void 0, function* () {
            ...
            let queueItem = yield mongo.findByID("queue-nsfw", queueItemID);
            if (action === 1) { // Approve
                ...
                yield mongo.insertOne("queue-nsfw-rejected", {
                    type: queueItem.animal === AnimalTypes_1.AnimalTypes.Furry.valueOf() ? AnimalTypes_1.AnimalTypes.Furry : AnimalTypes_1.AnimalTypes.NotFurry,
                    animal: queueItem.animal,
                    image: queueItem.image,
                    fact: queueItem.fact
            ...
            yield mongo.deleteByID("queue-nsfw", queueItemID);
            let status = yield (0, NextQueueItem_1.NextQueueItem)(i, mongo, "queue-nsfw");
...
//# sourceMappingURL=ContentQueueNSFW.js.map