...
const FoxxoIntervalUpsert_1 = require("../../Helpers/FoxxoIntervalUpsert");
function FoxxoOnATimerButtonHandler(mongo, interaction) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Insert into db
        yield (0, FoxxoIntervalUpsert_1.FoxxoIntervalUpsert)(mongo, { interval: interval, guildID: gid, channelID: cid });
